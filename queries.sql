...
SELECT producto.nombre, producto.precio, fabricante.nombre FROM producto
INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo ORDER BY fabricante.nombre ASC;
...
SELECT producto.nombre, producto.precio, fabricante.nombre FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante ORDER BY producto.precio DESC LIMIT 1;

SELECT producto.nombre, producto.precio FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre = 'Lenovo';

SELECT producto.nombre, producto.precio FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre = 'Crucial' AND producto.precio > 200;

SELECT producto.nombre, producto.precio FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre = 'Crucial' OR fabricante.nombre = 'Hewlett-Packard' OR fabricante.nombre = 'Seagate';

SELECT producto.nombre, producto.precio FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre IN('Crucial', 'Hewlett-Packard', 'Seagate');

SELECT producto.nombre, producto.precio FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre LIKE '%e';

SELECT producto.nombre, producto.precio FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre LIKE '%w%';

SELECT producto.nombre, producto.precio, fabricante.nombre FROM producto 
INNER JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE producto.precio >= 180 ORDER BY producto.precio DESC, producto.nombre;
...
LEFT JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre = 'Lenovo';
...
LEFT JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante 
WHERE fabricante.nombre = 'Lenovo' ORDER BY producto.precio DESC LIMIT 1;

SELECT producto.nombre FROM producto 
LEFT JOIN fabricante ON fabricante.codigo = producto.codigo_fabricante 
WHERE fabricante.nombre = 'Hewlett-Packard' ORDER BY producto.precio ASC LIMIT 1;
...
SELECT persona.apellido1, persona.apellido2, persona.nombre, departamento.nombre AS 'Nombre Departamento' FROM persona
INNER JOIN profesor ON persona.id = profesor.id_profesor LEFT JOIN departamento ON profesor.id_departamento = departamento.id ORDER BY persona.apellido1, persona.apellido2, persona.nombre;
...
LEFT JOIN asignatura ON asignatura.id = alumno_se_matricula_asignatura.id_asignatura
WHERE nif = '26902806M';
...
SELECT DISTINCT persona.* FROM universidad.curso_escolar
INNER JOIN alumno_se_matricula_asignatura ON alumno_se_matricula_asignatura.id_curso_escolar = curso_escolar.id
...
SELECT departamento.* FROM persona
...
SELECT departamento.nombre, COUNT(id) AS numero_de_profesores from departamento
INNER JOIN profesor ON profesor.id_departamento = departamento.id
GROUP BY id ORDER BY numero_de_profesores DESC;

SELECT departamento.nombre, COUNT(id_profesor) as numero_de_profesores from departamento
LEFT JOIN profesor ON profesor.id_departamento = departamento.id
GROUP BY id ORDER BY numero_de_profesores DESC;

SELECT grado.nombre, COUNT(asignatura.id_grado) as numero_de_asignaturas FROM grado
LEFT JOIN asignatura ON asignatura.id_grado = grado.id
GROUP BY grado.nombre ORDER BY numero_de_asignaturas DESC;

SELECT grado.nombre, COUNT(asignatura.id_grado) as numero_de_asignaturas FROM grado
LEFT JOIN asignatura ON asignatura.id_grado = grado.id
GROUP BY grado.nombre HAVING numero_de_asignaturas > 40 ORDER BY numero_de_asignaturas DESC;

SELECT grado.nombre, asignatura.tipo, SUM(asignatura.creditos) FROM grado
INNER JOIN asignatura ON asignatura.id_grado = grado.id
GROUP BY grado.nombre, asignatura.tipo;

SELECT COUNT(DISTINCT id_alumno), curso_escolar.anyo_inicio FROM alumno_se_matricula_asignatura
